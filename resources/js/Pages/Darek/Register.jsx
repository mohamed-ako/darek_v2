            ...
            <div className="SignIn SignUp">
                            ...
                            >
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                        d="M9.08182 3.86595C10.8254 2.61272 13.1746 2.61272 14.9182 3.86595L18.9182 6.74095C20.2252 7.68034 21 9.19147 21 10.801V16C21 18.7614 18.7614 21 16 21H8C5.23858 21 3 18.7614 3 16V10.801C3 9.19147 3.77484 7.68034 5.08182 6.74095L9.08182 3.86595ZM8 18C8 15.7909 9.79086 14 12 14C14.2091 14 16 15.7909 16 18C16 18.5523 15.5523 19 15 19H9C8.44771 19 8 18.5523 8 18Z"
                                        fill="#ffffff"
                                    ></path>{" "}
                                </g>
                            </svg>
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="flex flex-col items-center justify-center ">
                        <PrimaryButton className=" m-0" disabled={processing}>
                            <p
                                style={{
                                    textAlign: "center",
                                    color: "black",
