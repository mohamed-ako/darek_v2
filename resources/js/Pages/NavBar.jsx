...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <ul>
          <div className="navL">
            <main className="logoImg">
              <Link to="/Darek/Home" className="logo-cont">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
          ...
          <div className="navR">
            <li className="profileLogo">
              <Link to="/Darek/Profile" className="profilesvg">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link to="/Darek/Publisher" className="profilesvg">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link to="/Darek/Logout" className="profilesvg">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div clsseName="navS" style={{ display: navVisible ? "block" : "none" }}>
        <section>
          <main>
